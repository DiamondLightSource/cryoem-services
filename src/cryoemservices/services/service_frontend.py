...
class Frontend:
    ...
    def __init__(
        ...
        self.__hostid = generate_unique_host_id()
        ...
        if transport is None or isinstance(transport, basestring):
            self._transport_factory = lookup_services(transport)
        else:
        ...
        try:
            while not self.shutdown:
                ...
                if not self._transport.is_connected():
                    ...
                    raise Exception("Lost transport layer connection")
        finally:
    ...
    def switch_service(self, new_service=None):
        ...
        with self.__lock:
            ...
            if isinstance(self._service_factory, basestring):
                self._service_factory = lookup_services(self._service_factory)
