...
from cryoemservices.pipeliner_plugins import combine_star_files


@mock.patch("cryoemservices.pipeliner_plugins.combine_star_files.Path.rename")
...
@mock.patch("cryoemservices.pipeliner_plugins.combine_star_files.argparse._sys")
@mock.patch("cryoemservices.pipeliner_plugins.combine_star_files.combine_star_files")
@mock.patch("cryoemservices.pipeliner_plugins.combine_star_files.split_star_file")
